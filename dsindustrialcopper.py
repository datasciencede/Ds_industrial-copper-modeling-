...
with tab1:    
        ...
        with st.form("my_form"):
            ...
            with col3:               
                st.write( f'<h5 style="color:rgb(153, 0, 0,1);">NOTE: Min & Max given for reference, you can enter any value</h5>', unsafe_allow_html=True )
                quantity_tons = st.text_input("Enter Quantity Tons (Min:1 & Max:20000)")
...
with tab2: 
        ...
        with st.form("my_form1"):
            ...
            with col1:
                cquantity_tons = st.text_input("Enter Quantity Tons (Min:1 & Max:20000)")
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by mohit.r</h6>', unsafe_allow_html=True )  
